...
const PlayerItem = (props) => {
  ...
  const confirmSubirClausulaHandler = async () => {
    ...
    try {
      ...
      await sendRequest(
        ...
        "PATCH",
        JSON.stringify({
          clausula: Number(formState.inputs.cantidad.value),
        }),
        {
          "Content-Type": "application/json",
          Authorization: "Bearer " + auth.token,
      ...
      await sendRequest(
        ...
        "PATCH",
        JSON.stringify({
          presupuesto: Number(PresupuestoUser) - diferenciaClausulas,
        }),
        {
          "Content-Type": "application/json",
          Authorization: "Bearer " + auth.token,
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        footer={
          <React.Fragment>
            ...
            <Button danger onClick={confirmClausulaHandler}>
              PAGAR CLÁUSULA
            </Button>
          </React.Fragment>
        }
      ...
      <Modal
        ...
        footer={
          <React.Fragment>
            ...
            <Button danger onClick={confirmFreeBuyHandler}>
              FICHAR GRATIS
            </Button>
          </React.Fragment>
        }
      ...
      >
        <p>Sube la cláusula a este jugador</p>
              ...
              <div className="container-escudo">
                <div className="escudo">
                  <div className="escudo-img">
                    <img src={props.escudo} alt={props.escudo}></img>
                  </div>
                </div>
              </div>
